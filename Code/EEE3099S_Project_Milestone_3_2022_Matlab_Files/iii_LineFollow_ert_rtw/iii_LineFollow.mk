...
## Generated on : Mon Oct 09 15:38:34 2023
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/iii_LineFollow.elf
...
DEFINES_STANDARD = -DMODEL=iii_LineFollow -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_AnalogInput.o iii_LineFollow.o iii_LineFollow_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o mw_samd_nvic.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/iii_LineFollow_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/iii_LineFollow_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/iii_LineFollow_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/iii_LineFollow_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/iii_LineFollow_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/iii_LineFollow_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


iii_LineFollow.o : $(START_DIR)/iii_LineFollow_ert_rtw/iii_LineFollow.c
	$(CC) $(CFLAGS) -o "$@" "$<"


iii_LineFollow_data.o : $(START_DIR)/iii_LineFollow_ert_rtw/iii_LineFollow_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/iii_LineFollow_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/iii_LineFollow_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/iii_LineFollow_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
