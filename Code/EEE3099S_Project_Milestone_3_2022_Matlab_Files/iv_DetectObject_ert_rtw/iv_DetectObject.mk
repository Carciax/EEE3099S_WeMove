###########################################################################
## Makefile generated for component 'iv_DetectObject'. 
## 
## Makefile     : iv_DetectObject.mk
## Generated on : Thu Oct 05 17:33:49 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/iv_DetectObject.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/iv_DetectObject.elf
...
DEFINES_STANDARD = -DMODEL=iv_DetectObject -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_AnalogInput.o MW_Ultrasonic.o iv_DetectObject.o iv_DetectObject_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o mw_samd_nvic.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/iv_DetectObject_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/iv_DetectObject_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/iv_DetectObject_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/iv_DetectObject_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/iv_DetectObject_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/iv_DetectObject_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


iv_DetectObject.o : $(START_DIR)/iv_DetectObject_ert_rtw/iv_DetectObject.c
	$(CC) $(CFLAGS) -o "$@" "$<"


iv_DetectObject_data.o : $(START_DIR)/iv_DetectObject_ert_rtw/iv_DetectObject_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/iv_DetectObject_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/iv_DetectObject_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/iv_DetectObject_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
