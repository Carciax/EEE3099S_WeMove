...
## Generated on : Wed Oct 11 12:39:56 2023
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ii_90degree.elf
...
DEFINES_STANDARD = -DMODEL=ii_90degree -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/ii_90degree_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ii_90degree_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ii_90degree_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ii_90degree_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ii_90degree_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ii_90degree.o : $(START_DIR)/ii_90degree_ert_rtw/ii_90degree.c
	$(CC) $(CFLAGS) -o "$@" "$<"
