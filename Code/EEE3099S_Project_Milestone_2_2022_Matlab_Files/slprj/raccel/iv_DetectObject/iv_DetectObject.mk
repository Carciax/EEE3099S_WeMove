...
MODEL                   = iv_DetectObject
MODULES                 = rt_matrx.c rt_printf.c iv_DetectObject.c iv_DetectObject_capi.c iv_DetectObject_data.c iv_DetectObject_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c raccel_sfcn_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = iv_DetectObject
MAKEFILE                = iv_DetectObject.mk
MATLAB_ROOT             = /Applications/MATLAB_R2023a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2023a.app
START_DIR               = /Users/cameronclark/Documents/UCT/EEE3099S/EEE3099S_CKT/Code/EEE3099S_Project_Milestone_2_2022_Matlab_Files
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = MACI64
...
DEFINES_CUSTOM          = -DEXT_MODE -DIS_RAPID_ACCEL -DRACCEL_ENABLE_PARALLEL_EXECUTION -DRACCEL_PARALLEL_EXECUTION_NUM_THREADS=4 -DRACCEL_NUM_PARALLEL_NODES=2 -DRACCEL_PARALLEL_SIMULATOR_TYPE=0 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/iv_DetectObject \
